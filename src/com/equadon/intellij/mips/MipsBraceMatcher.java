...
public class MipsBraceMatcher implements PairedBraceMatcher {
  private static final BracePair[] PAIRS = new BracePair[] {
    new BracePair(MipsElementTypes.LPAREN, MipsElementTypes.RPAREN, false),
    new BracePair(MipsElementTypes.LQUOTE, MipsElementTypes.RQUOTE, false)
  };
  ...
  public boolean isPairedBracesAllowedBeforeType(@NotNull IElementType lBraceType, @Nullable IElementType type) {
    return MipsTokenTypes.WHITE_SPACES.contains(type) ||
        MipsTokenTypes.COMMENTS.contains(type) ||
        type == MipsElementTypes.RPAREN ||
        type == MipsElementTypes.RQUOTE;
  }
