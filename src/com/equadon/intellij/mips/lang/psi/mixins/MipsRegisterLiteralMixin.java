...
public class MipsRegisterLiteralMixin extends MipsNamedElementImpl {
  public MipsRegisterLiteralMixin(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public boolean hasOffset() {
    return findChildByType(MipsElementTypes.REGISTER_OFFSET) != null;
  }

  public String getOffset() {
    return findChildByType(MipsElementTypes.REGISTER_OFFSET);
  }
}
