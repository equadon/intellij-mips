...
public class MipsStringLiteralMixin extends MipsNamedElementImpl implements MipsNamedElement {
  public MipsStringLiteralMixin(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public PsiElement getNameIdentifier() {
    return findChildByType(MipsElementTypes.QUOTED_STRING);
  }
}
